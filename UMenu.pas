...
var
  xMenu: TMenuThread;
begin
  DM_PRINCIPAL.FMenuAccess := TMenuAccess.Create(DM_PRINCIPAL.IBQuery1, DM_PRINCIPAL.FParameters.Access, False);
...
begin
  ...
  if Assigned(frmMenu) then
    frmMenu.Caption := 'Usuário Logado: ' + DM_PRINCIPAL.FParameters.Login;
