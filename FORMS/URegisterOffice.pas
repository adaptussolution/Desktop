...
begin
  ...
  begin
    Application.MessageBox('POR FAVOR INFORME O CARGO!', 'ATENÇÃO', MB_OK + MB_ICONWARNING);
    dbedtNOME.SetFocus;
    Result := True;
    Exit;
  end;
  ...
  begin
    ...
    begin
      Application.MessageBox('POR FAVOR INFORME OUTRO CARGO, POIS ESSE, JÁ ESTÁ FOI REGISTRADO!', 'ATENÇÃO', MB_OK + MB_ICONWARNING);
      dbedtNOME.SetFocus;
      Result := True;
      Exit;
    end;
