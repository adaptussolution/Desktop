...
begin
  ...
  begin
    Application.MessageBox('POR FAVOR INFORME O LOGIN!', 'ATENÇÃO', MB_OK + MB_ICONWARNING);
    dbedtLOGIN.SetFocus;
    Result := True;
    Exit;
  end;
  ...
  begin
    Application.MessageBox('POR FAVOR INFORME A SENHA!', 'ATENÇÃO', MB_OK + MB_ICONWARNING);
    dbedtSENHA.SetFocus;
    Result := True;
    Exit;
  end;
