...
type
    ...
    published
        ...
        property CaptionFontColor : TColor read GetCaptionFontColor write SetCaptionFontColor;
...
begin
    ...
    begin
        ...
        m_CaptionFontColor := m_FileTheme.GetColor(SUI_THEME_MENU_SELECTED_FONT_COLOR);
    end
    else
    begin
...
function TsuiSideChannel.GetCaptionFontColor: TColor;
begin
    Result := Font.Color;
end;
